...
| --- | --- | --- | --- | --- | --- |
| CTS backend | Yes | TCP | 443 | <ul><li>nttsecurity.io (\*.nttsecurity.io, \*.\*.nttsecurity.io)<ul><li>cts.eu1.nttsecurity.io</li></ul></ul> | CTS API backend communication and telemetry |
| Collector backend | Yes | TCP | 443 | <ul><li>samurai-xdr-prod-westeurope-xgliuoit.azure-api.net</li><li>api.eu.mdr.security.ntt</li></ul> | Collector API backend communication and telemetry for Samurai service |
